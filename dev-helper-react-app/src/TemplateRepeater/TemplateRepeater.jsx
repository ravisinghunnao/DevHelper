                ...
                <div className="col-md-4">
                    ...
                    <div className="col-md-12 center mt-2">
                        <div className="btn-group btn-group-justified">
                            <button className="btn btn-sm btn-primary">Remove Enter</button>
                            <button className="btn btn-sm btn-primary">Convert To Title Case</button>
                            <button className="btn btn-sm btn-primary">Remove Space</button>
                            <button className="btn btn-sm btn-primary">Remove Special Charecters</button>
                        </div>
                    </div>
